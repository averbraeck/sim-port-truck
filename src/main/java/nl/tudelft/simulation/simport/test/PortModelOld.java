 ...
 */
public class PortModelOld extends AbstractDsolModel<Duration, ClockDevsSimulatorInterface>
{
    /** interactive run? */
     ...
     */
    public PortModelOld(final ClockDevsSimulatorInterface simulator)
    {
        super(simulator);
    }
