 ...
 */
public class CentroidAnimation extends SimRenderable2d<Centroid>
{
    /**
     *
     */
    public CentroidAnimation(final Centroid centroid, final SimulatorInterface<?> simulator)
    {
        super(centroid, simulator);
        setScale(false);
    }
    ...
    {
        var ellipse = new Ellipse2D.Double(-4.0, -4.0, 8, 8);
